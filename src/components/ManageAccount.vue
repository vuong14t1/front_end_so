  ...
  <div>
    ...
    <div style="width: 98%;float: left">
     ...
     <button @click="filterAccount()" class="button is-primary mb-2" style="float: right">Tìm kiếm</button>
            <input class="input is-primary is-medium"  v-model="search" @keydown.enter="filterAccount" style="float: right;width: 10%; height: 40px" />
    </div>
            ...
            <table class="table is-bordered container is-fullwidth has-text-centered mt-3" style="font-size: 15px">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <DropDown :type="ObjectConst.DROP_DOWN.ROLE" :title="AccountRole[role].title"
                      :items="AccountRole" :id="accountCreated._id" @clicked="onClickChildCreated"></DropDown>
      ...
      <table class="table is-bordered container is-fullwidth has-text-centered mt-3" style="font-size: 15px">
        ...
        <tbody style="width: 1000px">
          <tr >
            ...
            <td> <input class="has-text-centered" style="width: 100px; height: 50px;" v-model="accountUpdate.email" /></td>
            <td>
              <DropDown style="width: 130px; height: 50px; text-align: center"  :type="ObjectConst.DROP_DOWN.ROLE" :title="AccountRole[accountUpdate.role].title" :items="AccountRole"
                :id="accountUpdate._id" @clicked="onClickChild"> </DropDown>
            </td>
            <td><input placeholder="password" type="password" style="width: 100px; height: 50px;" v-model="accountUpdate.password" /> </td>
          </tr>
        </tbody>
      </table>
    </div>
